...
<section class="container">
    <!-- Hero Image & Texts -->
    <div class="flex flex-col rounded-3xl justify-center text-primary-80 aspect-video p-7 bg-cover max-lg:after:bg-accent-0/65 bg-no-repeat after:rounded-3xl after:inset-0 after:absolute relative after:-z-[1] isolate" style="background-color: linear-gradient(270deg, rgba(119, 119, 119, 0) 13.27%, #5B5B5B 100%); background-image: url('<?php echo wp_get_attachment_image_url($hero_image, "full", false, ["class" => ""]) ?>');">
        <div class="text-title_2 w-1/3 font-bold max-md:text-h4 max-md:font-[500] max-lg:w-full">
        ...
        <div class="grid grid-cols-12">
            <cyn-button class="reservePopUpOpener border rounded-3xl justify-center items-center col-span-2 max-lg:col-span-6" type="primary" href="#">
